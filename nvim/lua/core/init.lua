...
local disable_distribution_plugins = function()
  ...
  vim.g.loaded_spellfile_plugin = 2
...
local neovide_config = function()
  -- vim.api.nvim_set_option_value('guifont', 'MesloLGS NF:h13', {})
  vim.api.nvim_command [[let g:neovide_transparency = 0.7]]
  vim.api.nvim_command [[let g:transparency = 0.7 ]]
  -- vim.api.nvim_command [[let g:neovide_background_color = '#0f1117'.printf('%x', float2nr(255 * g:transparency))]]
